 ...
 * 图片模块adapter
 */
public class AdVideoContent extends BaseQuickAdapter<MediaListBean.ListBean, BaseViewHolder> {

    public AdVideoContent(int layoutResId, @Nullable List<MediaListBean.ListBean> data) {
