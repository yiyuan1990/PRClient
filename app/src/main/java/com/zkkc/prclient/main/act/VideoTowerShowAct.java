 ...
 * 塔文件夹展示
 */
public class VideoTowerShowAct extends BaseActivity<TowerShowContract.View, TowerShowContract.Presenter> implements TowerShowContract.View {
    ...
    public void init() {
        ...
        towerContentAd.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                startActivity(new Intent(VideoTowerShowAct.this, TowerVideoAct.class));
            }
        });
